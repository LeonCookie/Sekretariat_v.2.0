               ...
               using (StreamReader fs = File.OpenText(fileName))
                           ...
                           string[] dane_linia;
                               ...
                               if(NazwaBomboBox.Text != "" && KryteriaComboBox.Text != "" && LiteraTextBox.Text != "")
                               {
                                   ...
                                   {
                                       if (KryteriaComboBox.Text == "rÛwne" && LiteraTextBox.Text == dane_linia[1])
                                       {
                                           wynik = wynik + linia+ "\n";
                                       }
                                   ...
                                   {
                                       if (KryteriaComboBox.Text == "rÛwne" && LiteraTextBox.Text == dane_linia[2])
                                       {
                                           wynik = wynik + linia+"\n";
                                       }
                                   ...
                                   {
                                       if (KryteriaComboBox.Text == "rÛwne" && LiteraTextBox.Text == dane_linia[3])
                                       {
                                           wynik = wynik + linia+ "\n";
                                       }
